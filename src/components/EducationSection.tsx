...
const EducationSection = () => {
  const education = [
    {
      title: "Analista de Datos - BI Analyst",
      institution: "Jupi Digital",
      year: "2025",
      status: "Completado",
      description:
        "Bootcamp intensivo de análisis de datos con enfoque en herramientas modernas y metodologías ágiles.",
      skills: [
        "Data Engineering",
    ...
    {
      title: "Certificado Profesional de Analista de Datos",
      institution: "Coursera",
      year: "2024",
      status: "Completado",
      description:
        "Certificación profesional que cubre el ciclo completo del análisis de datos, desde la recolección hasta la presentación de insights.",
      skills: [
        "Data Cleaning",
        ...
        <div className="mt-16 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-8">
          ...
          <div className="text-center">
            <p className="text-slate-600 mb-6 max-w-2xl mx-auto">
              Comprometido con el aprendizaje continuo y la actualización
              constante en las últimas tendencias y herramientas del análisis de
